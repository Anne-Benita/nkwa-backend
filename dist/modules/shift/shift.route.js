 ...
 */
router.post('/start', auth_middleware_1.default, shift_controller_1.shiftController.start);
/**
 * @swagger
 * /shifts/{shiftId}/stop:
 *   post:
 ...
 *         description: Unauthorized.
 */
router.post('/:shiftId/stop', auth_middleware_1.default, shift_controller_1.shiftController.stop);
/**
 * @swagger
 * /shifts/current:
 *   get:
 ...
 *         description: Unauthorized.
 */
router.get('/current', auth_middleware_1.default, shift_controller_1.shiftController.getCurrent);
/**
 * @swagger
 * /shifts/history:
 *   get:
 ...
 *         description: Unauthorized.
 */
router.get('/history', auth_middleware_1.default, shift_controller_1.shiftController.getHistory);
/**
 * @swagger
 * /shifts/{shiftId}:
 *   get:
 ...
 *         description: Unauthorized.
 */
router.get('/:shiftId', auth_middleware_1.default, shift_controller_1.shiftController.getDetails);
