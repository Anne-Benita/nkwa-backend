 ...
 */
router.get('/', auth_middleware_1.default, wallet_controller_1.walletController.getSummary);
/**
 * @swagger
 * /wallet/transactions:
 *   get:
 ...
 *         description: Unauthorized.
 */
router.get('/transactions', auth_middleware_1.default, wallet_controller_1.walletController.getTransactions);
/**
 * @swagger
 * /wallet/withdraw:
 *   post:
 ...
 *         description: Unauthorized.
 */
router.post('/withdraw', auth_middleware_1.default, wallet_controller_1.walletController.withdraw);
